...
月曜日の朝、7時。ユウタは資金95円を見つめていた。前週の成功（+15円）で、少し自信がついている。

「今週も技術指標を使って、しっかり分析するぞ」

パソコンの前に座り、10銘柄を分析し始めた。BTC, ETH, XRP, ADA, DOT, LINK, AVAX, MATIC, UNI, ATOM。

3時間後。

画面には、10銘柄すべての分析結果が並んでいる。

```
BTC: RSI 45, MACD上昇 → 買い
ETH: RSI 52, MACD横ばい → 中立
XRP: RSI 38, MACD上昇 → 買い
ADA: RSI 41, MACD上昇 → 買い
DOT: RSI 58, MACD横ばい → 中立
LINK: RSI 35, MACD上昇 → 買い
AVAX: RSI 48, MACD上昇 → 買い
MATIC: RSI 44, MACD上昇 → 買い
UNI: RSI 39, MACD上昇 → 買い
ATOM: RSI 42, MACD上昇 → 買い
```

8銘柄が「買い」候補。どれも良さそうに見える。

ユウタは頭を抱えた。

「全部買いたい...でも95円しかない」

「1つに全額投資するのは怖い...でも、複数買うほど資金がない」

「間違った銘柄を選んだらどうしよう...」

時計を見ると、もう午前10時。3時間も分析したのに、まだ決められない。
...
「ミコ...実は、8銘柄が買い候補なんだけど、どれを選べばいいか分からなくて...」

ミコはユウタの画面を覗き込む。10銘柄の分析結果、3時間分の作業。
...
「1つが暴落しても、他でカバーできる。これが分散投資だ」

「でも、どの組み合わせがいいの？」

ミコはニヤリと笑う。

「それを教えてくれるツールがある。相関分析だ」
...
数秒後、画面に巨大なマトリックスが表示された。10銘柄の相関係数が一覧になっている。

```
          BTC   ETH   XRP   ADA   DOT  LINK ...
BTC      1.00  0.85  0.42  0.61  0.73  0.73
ETH      0.85  1.00  0.38  0.73  0.68  0.78
XRP      0.42  0.38  1.00  0.29  0.35  0.35
...
```
...
「BTCとETHって、0.85...ほぼ同じ動きしてるのか」

「そう。だから両方買っても、分散の意味がない」

ミコは画面を指差す。

「でも、BTCとXRPは0.42。相関が低い」
...
相関分析の説明を聞いた後、ユウタは実践を始めた。

「よし、まず買い候補を絞り込もう」

Week 2で学んだ通り、材料と技術指標で10銘柄をスキャン。
...
ユウタは再び悩み始める。しかし今度は、ミコが教えてくれたツールがある。
...
「あれ、XRPが全部の組み合わせに入ってる！」

ミコが頷く。

「そう。XRPは他の銘柄と相関が低いから、分散投資の核になる」

「なるほど...じゃあ、XRP + ADAが最も低相関（0.29）だから、これがベストか」

「その通りだ。しかも両方ともβ < 1でローリスク。お前にぴったりだ」
...
45円: ADA（β=0.94、XRPと最も低相関0.29）
合計β: 約0.89（ローリスク型）
```

「これで、リスクを分散しながら、安定したリターンを狙える」

ミコが補足する。

「いい選択だ。もし次に3銘柄に分散したいなら、ATOMも追加できる」
...
XRP: 投資50円 → 利確+7.75円（+15.5%）
ADA: 投資45円 → 利確+7.56円（+16.8%）
...
```
XRPのみに95円: +14.73円（109.73円）
ADAのみに95円: +15.96円（110.96円）
```
...
ユウタは2日目を思い出す。XRPが下がった時、ADAが上がってカバーしてくれた。

「あの安心感が違う」

「1銘柄だけなら、-2%の時点でパニックになってた」

「これが分散投資のメリットか...」

ミコが補足する。

「今回は両方とも上がったから、リターンは同じだった」

「でも、もし1つが暴落してたら、分散投資の方が圧倒的に有利だったはずだ」
...
- 総文字数: 20,256文字
- 全8Part完成
- ストーリー、相関分析、ベータ値、実践ガイド全て完備
- 5ステップ作成プロセスに従って作成

次回: Week 4「カスタム指標とバックテスト - 自動化への道」
